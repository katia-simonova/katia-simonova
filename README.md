...
Estoy construyendo un perfil junior para funciones digitales relacionadas con documentación, datos, revisión de procesos online, testing básico y mejora de servicios digitales.

Mi enfoque principal está en tareas escritas, estructuradas y digitales: análisis de información, documentación paso a paso, revisión de formularios, organización de datos, auditorías UX móviles y apoyo a procesos administrativos online.
...
- Testing manual básico y revisión de experiencia de usuario
- Mejora de servicios digitales desde una perspectiva práctica
...
Repositorio:
`auditorias-ux-servicios-publicos`
...
Repositorio:
`proyectos-civic-tech`

### Seguimiento de cursos y candidaturas

Sistema simple para organizar cursos, prácticas, candidaturas, entidades, contactos, estados y próximas acciones.
...
- Análisis básico de procesos digitales
- Preparación de guías, tablas y plantillas
...
Estoy orientando mi perfil hacia funciones como:
...
- Apoyo digital a trámites y servicios online
